 ...
 */
public abstract class Hilt_FirstSplashFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FirstSplashFragment() {
    super();
  }

  Hilt_FirstSplashFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FirstSplashFragment_GeneratedInjector) this.generatedComponent()).injectFirstSplashFragment(UnsafeCasts.<FirstSplashFragment>unsafeCast(this));
    }
  }
