 ...
 */
public abstract class Hilt_PublishReportFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PublishReportFragment() {
    super();
  }

  Hilt_PublishReportFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PublishReportFragment_GeneratedInjector) this.generatedComponent()).injectPublishReportFragment(UnsafeCasts.<PublishReportFragment>unsafeCast(this));
    }
  }
