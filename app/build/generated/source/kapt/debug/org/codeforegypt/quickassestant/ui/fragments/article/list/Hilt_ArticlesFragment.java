 ...
 */
public abstract class Hilt_ArticlesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ArticlesFragment() {
    super();
  }

  Hilt_ArticlesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ArticlesFragment_GeneratedInjector) this.generatedComponent()).injectArticlesFragment(UnsafeCasts.<ArticlesFragment>unsafeCast(this));
    }
  }
