 ...
 */
public abstract class Hilt_EmergencyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EmergencyFragment() {
    super();
  }

  Hilt_EmergencyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmergencyFragment_GeneratedInjector) this.generatedComponent()).injectEmergencyFragment(UnsafeCasts.<EmergencyFragment>unsafeCast(this));
    }
  }
