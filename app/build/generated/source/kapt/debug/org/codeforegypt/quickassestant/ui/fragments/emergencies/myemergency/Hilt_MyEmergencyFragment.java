 ...
 */
public abstract class Hilt_MyEmergencyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyEmergencyFragment() {
    super();
  }

  Hilt_MyEmergencyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyEmergencyFragment_GeneratedInjector) this.generatedComponent()).injectMyEmergencyFragment(UnsafeCasts.<MyEmergencyFragment>unsafeCast(this));
    }
  }
